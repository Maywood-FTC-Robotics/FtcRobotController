 ...
 */
public class UnscaledMecanumDriveKinematics {
     ...
     *                              physical center of the robot.
     */
    public UnscaledMecanumDriveKinematics(Translation2d frontLeftWheelMeters,
    ...
    /**
     * Construct inverse kinematics matrix from wheel locations. NOTE: SCALING WAS REMOVED HERE in this class
     *
    ...
    public void resetKinematics(Translation2d fl, Translation2d fr,
                           Translation2d rl, Translation2d rr)
    {
        m_frontLeftWheelMeters = fl;
        m_frontRightWheelMeters = fr;
        m_rearLeftWheelMeters = rl;
        m_rearRightWheelMeters = rr;
        setInverseKinematics(m_frontLeftWheelMeters, m_frontRightWheelMeters,
                m_rearLeftWheelMeters, m_rearRightWheelMeters);
